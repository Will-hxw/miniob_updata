...
public:
  ...
  // virtual RC update_record(Table *table, Record &record, const std::pair<Value,FieldMeta> &target) = 0;
  // virtual RC update_record(Table *table, Record &record, const std::pair<Value,char> &target) = 0;
